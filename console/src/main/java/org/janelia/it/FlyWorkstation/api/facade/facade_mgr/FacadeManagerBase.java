...
public abstract class FacadeManagerBase {
   ...
   public abstract OntologyLoader getOntologies() throws Exception;
   ...
   public abstract String getServerName();
    ...
    // todo Might want more concrete facade layers later on
    public abstract EntityLoader getFacade(EntityType entityType) throws Exception;
