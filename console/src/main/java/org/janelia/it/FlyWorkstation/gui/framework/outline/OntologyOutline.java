 ...
 */
public class OntologyOutline extends JScrollPane implements Cloneable {
    public static final String NO_DATASOURCE = "Ontology Unreachable";
    private ConsoleFrame consoleFrame;
    private JTree tree;
    private static final String ANNOTATION_SESSIONS = "Annotation Sessions";

    public OntologyOutline(ConsoleFrame consoleFrame) {
...
//                System.out.println("Selected "+treeSelectionEvent.getPath());
                ...
                if (null != tmpTask && !"".equals(tmpTask)) {
                    OntologyOutline.this.consoleFrame.setMostRecentFileOutlinePath(tmpTask);
                }
            }
        }));
