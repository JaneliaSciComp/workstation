...
public class DataviewMenuBar extends JMenuBar {
    ...
    protected DataviewMenuBar(final DataviewFrame dataview) {
        ...
        menuFileSearchById.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
				final String entityId = (String) JOptionPane.showInputDialog(dataview, "Entity id: ", "Search by entity id",
				...
				SimpleWorker searchWorker = new SimpleWorker() {
		            ...
		            protected void doStuff() throws Exception {
		            	entity = EJBFactory.getRemoteAnnotationBean().getEntityById(entityId);
		            }
        ...
        menuFileSearchByName.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
				...
				final String entityName = (String) JOptionPane.showInputDialog(dataview, "Entity name: ", "Search by entity name",
						JOptionPane.PLAIN_MESSAGE, null, null, null);
				...
				SimpleWorker searchWorker = new SimpleWorker() {
		            ...
		            protected void doStuff() throws Exception {
		            	entities = new ArrayList<Entity>(EJBFactory.getRemoteAnnotationBean().getEntitiesByName(entityName));
		            }
