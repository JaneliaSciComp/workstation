...
import org.janelia.it.FlyWorkstation.gui.viewer3d.shader.RGBExcludableShader;
 ...
 *
 */
public class RGBExcludableVolumeBrick implements GLActor, VolumeDataAcceptor
{
    ...
    RGBExcludableVolumeBrick(VolumeModel volumeModel) {
