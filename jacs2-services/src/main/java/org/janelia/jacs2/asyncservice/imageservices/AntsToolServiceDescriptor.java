...
/**
 * Service based on Advanced Normalization Tools (ANTS).
 */
@Named("antsTool")
public class AntsToolServiceDescriptor implements ServiceDescriptor {
    ...
    @Inject
    AntsToolServiceDescriptor(AntsToolProcessor antsToolProcessor) {
    ...
    @Override
    public AntsToolProcessor createServiceProcessor() {
        return antsToolProcessor;
    }
