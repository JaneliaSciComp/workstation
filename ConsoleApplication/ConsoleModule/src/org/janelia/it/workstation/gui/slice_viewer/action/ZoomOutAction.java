...
public class ZoomOutAction extends AbstractAction 
{
	...
	public ZoomOutAction(org.janelia.it.workstation.gui.camera.Camera3d camera) {
		this.camera = camera;
		putValue(NAME, "Zoom Out");
		putValue(SMALL_ICON, org.janelia.it.workstation.gui.util.Icons.getIcon("magnify_minus.png"));
