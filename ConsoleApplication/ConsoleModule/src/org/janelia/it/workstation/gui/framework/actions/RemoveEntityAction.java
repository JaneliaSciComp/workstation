...
public class RemoveEntityAction implements Action {
    ...
    public void doAction() {
        ...
        SimpleWorker verifyTask = new SimpleWorker() {
            ...
            private Set<EntityData> removeTree = new HashSet<>();
            private Set<EntityData> removeReference = new HashSet<>();
            private Set<EntityData> removeRootTag = new HashSet<>();
            private Map<EntityData, String> sharedNameMap = new HashMap<>();
            ...
            protected void doStuff() throws Exception {
                ...
                for (EntityData ed : toDelete) {
                    ...
                    Map<Long, EntityData> respectedEds = new HashMap<>();
            ...
            protected void hadSuccess() {
                ...
                final Set<EntityData> toReallyDelete = new HashSet<>(toDelete);
                for (EntityData ed : toDelete) {
                    Entity child = ed.getChildEntity();
