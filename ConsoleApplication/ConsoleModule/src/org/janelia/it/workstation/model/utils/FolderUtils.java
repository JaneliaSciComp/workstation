...
public class FolderUtils {
    ...
    public static RootedEntity saveEntitiesToFolder(RootedEntity saveFolder, List<Long> entityIds) throws Exception {
        saveEntities(saveFolder.getEntity(), entityIds);
        return saveFolder;
    }
