 ...
 */
public class TestMipRenderer extends BaseRenderer
{
    ...
    private TestVolumeModel volumeModel;
    ...
    // scene objects
    public TestMipRenderer() {
        logger = LoggerFactory.getLogger(TestMipRenderer.class);
        // actors.add(new TeapotActor()); // solid shading is not supported right now
        volumeModel = new TestVolumeModel();
    ...
    private double getMaxRes() {
        TestVolumeModel model = getVolumeModel();
