...
public abstract class GLShaderProgram {
    ...
    public GLShaderProgram(GLShaderProperties properties) {
        this.properties=properties;
    }

    public GLShaderProgram() {}

    public void setProperties(GLShaderProperties properties) {
        this.properties=properties;
    }
...
//            logger.info("MAX_SHADER_STORAGE_BUFFER_BINDINGS="+lb.get(0));
    ...
    public boolean setUniform3i(GL4 gl, String varName, int x, int y, int z)
    {
        int uniformLoc = gl.glGetUniformLocation( shaderProgram, varName );
        if ( uniformLoc < 0 )
            return false;
        gl.glUniform3i( uniformLoc, x, y, z);
        return true;
    }
