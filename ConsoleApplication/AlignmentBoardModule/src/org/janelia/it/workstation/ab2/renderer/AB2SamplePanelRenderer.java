...
public class AB2SamplePanelRenderer extends AB2Renderer2D {
    ...
    public AB2SamplePanelRenderer(int x, int y, int width, int height, int screenWidth, int screenHeight, GLRegion parentRegion) {
        super(parentRegion);
