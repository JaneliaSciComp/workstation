...
*/
{
    ...
    public synchronized void deleteNeuron(TmNeuronMetadata deletedNeuron) throws Exception {
     ...
     */
    private void removeAnchoredPath(TmNeuronMetadata neuron, TmAnchoredPath path) throws  Exception {
