 ...
 * djo, 5/13
 */
public class BasicAnnotationPanel extends AnnotationPanel
{
    ...
    public BasicAnnotationPanel(AnnotationManager annotationMgr, LargeVolumeViewerTranslator largeVolumeViewerTranslator) {
