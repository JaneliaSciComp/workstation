 ...
 */
public class IconGridViewerFind<T,S> {

    private static final Logger log = LoggerFactory.getLogger(IconGridViewerFind.class);
    
    private final IconGridViewerPanel<T,S> iconGridViewer;
    ...
    public IconGridViewerFind(IconGridViewerPanel<T,S> iconGridViewer, String searchString, T startingObject, 
            Bias bias, boolean skipStartingNode) {
        this.iconGridViewer = iconGridViewer;
        this.searchString = searchString==null?null:searchString.toUpperCase();
        this.startingObject = startingObject==null?iconGridViewer.getObjectList().get(0):startingObject;
    ...
    public T find() {
        ...
        List<T> objectList = new ArrayList<>(iconGridViewer.getObjectList());
    ...
    private T checkCurrent(T currObject) {
        String name = iconGridViewer.getImageModel().getImageLabel(currObject);
