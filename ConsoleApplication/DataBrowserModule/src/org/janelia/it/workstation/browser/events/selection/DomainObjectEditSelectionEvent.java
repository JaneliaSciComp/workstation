...
public class DomainObjectEditSelectionEvent {
    ...
    public DomainObjectEditSelectionEvent(Object source, AbstractDomainObjectNode<?> domainObjectNode, boolean select, boolean clearAll, boolean isUserDriven) {
        this.source = source;
    ...
    public String toString() {
        ...
        return "DomainObjectEditSelectionEvent [source=" + s + ", domainObjectNode=" + domainObjectNode + ", domainObjects=" + domainObjects
