...
public class DomainListViewManager implements ViewerManager<DomainListViewTopComponent> {
    ...
    public void domainObjectSelected(DomainObjectSelectionEvent event) {
        ...
        if (!Utils.hasAncestorWithType((Component)event.getSource(),DomainExplorerTopComponent.class) && !DomainObjectContextMenu.class.isAssignableFrom(event.getSource().getClass())) {
