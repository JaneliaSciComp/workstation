...
public class OntologyTermNodeFlavor extends DataFlavor {
    ...
    public static final DataFlavor SINGLE_FLAVOR = createConstant("application/x-domain-object;class=org.janelia.it.workstation.browser.nodes.OntologyTermNode","Ontology Term Node");
