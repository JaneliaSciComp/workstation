...
public class DomainDAO {
    ...
    public <T extends DomainObject> List<T> getDomainObjects(String subjectKey, String className, Collection<Long> ids) {
    	...
    	try {
    		...
    		log.error("Illegal class name: "+className,e);
    ...
    public void addIntakeOrder(IntakeOrder order) throws Exception {
        log.info("adding IntakeOrder (orderNo={}, owner={})", order.getOrderNo(), order.getOwner());
    ...
    public List<IntakeOrder> getIntakeOrder(String orderNo) throws Exception {
        return toList(intakeOrdersCollection.find("{orderNo: #}}", orderNo).as(IntakeOrder.class));
    }

    public void addSampleToOrder(String orderNo, Long sampleId) throws Exception {
        Long[] samples = {sampleId};
        addSampleIdsToOrder(orderNo, samples);
    }
