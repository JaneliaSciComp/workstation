...
package org.janelia.it.jacs.compute.launcher.geci.geci;
 ...
 * @author Tareq Nabeel
 */
@MessageDriven(name = "NeuronalAssayAnalysisLauncherMDB", activationConfig = {
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge "),
        @ActivationConfigProperty(propertyName = "messagingType", propertyValue = "javax.jms.MessageListener"),
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/neuronalAssayLauncher"),
...
public class NeuronalAssayAnalysisLauncherMDB extends SeriesLauncherMDB {
