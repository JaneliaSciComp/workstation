...
package org.janelia.it.jacs.compute.launcher.inspect.inspect;
 ...
 * @author Tareq Nabeel
 */
@MessageDriven(name = "InspectLauncherMDB", activationConfig = {
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge "),
        @ActivationConfigProperty(propertyName = "messagingType", propertyValue = "javax.jms.MessageListener"),
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/inspectLauncher"),
...
public class InspectLauncherMDB extends SeriesLauncherMDB {
