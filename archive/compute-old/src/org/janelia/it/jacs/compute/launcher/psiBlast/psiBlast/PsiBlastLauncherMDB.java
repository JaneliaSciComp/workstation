...
package org.janelia.it.jacs.compute.launcher.psiBlast.psiBlast;
 ...
 * @author Tareq Nabeel
 */
@MessageDriven(name = "PsiBlastLauncherMDB", activationConfig = {
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge "),
        @ActivationConfigProperty(propertyName = "messagingType", propertyValue = "javax.jms.MessageListener"),
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/psiBlastLauncher"),
...
public class PsiBlastLauncherMDB extends SeriesLauncherMDB {
