...
package org.janelia.it.jacs.compute.launcher.prokAnnotation.prokAnnotation;

import org.janelia.it.jacs.compute.engine.launcher.ejb.SequenceLauncherMDB;
 ...
 * @author Tareq Nabeel
 */
@MessageDriven(name = "ProkAnnotationServiceLoadLauncherMDB", activationConfig = {
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge "),
        @ActivationConfigProperty(propertyName = "messagingType", propertyValue = "javax.jms.MessageListener"),
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/prokASLoaderLauncher"),
...
public class ProkAnnotationServiceLoadLauncherMDB extends SequenceLauncherMDB {
