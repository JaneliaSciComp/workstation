...
package org.janelia.it.jacs.compute.launcher.barcodeDesigner.barcodeDesigner;
 ...
 * @author Tareq Nabeel
 */
@MessageDriven(name = "BarcodeDesignLauncherMDB", activationConfig = {
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge "),
        @ActivationConfigProperty(propertyName = "messagingType", propertyValue = "javax.jms.MessageListener"),
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/barcodeLauncher"),
...
public class BarcodeDesignLauncherMDB extends SeriesLauncherMDB {
