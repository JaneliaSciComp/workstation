...
package org.janelia.it.jacs.compute.launcher.frvblast.frvblast;
 ...
 * @author Tareq Nabeel
 */
@MessageDriven(name = "FrvBlastLauncherMDB", activationConfig = {
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge "),
        @ActivationConfigProperty(propertyName = "messagingType", propertyValue = "javax.jms.MessageListener"),
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/frvBlastLauncher"),
...
public class FrvBlastLauncherMDB extends SeriesLauncherMDB {
