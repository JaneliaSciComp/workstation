...
package org.janelia.it.jacs.compute.launcher.hmmer.hmmer;
 ...
 * @author Tareq Nabeel
 */
@MessageDriven(name = "HmmLauncherMDB", activationConfig = {
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge "),
        @ActivationConfigProperty(propertyName = "messagingType", propertyValue = "javax.jms.MessageListener"),
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/hmmLauncher"),
...
public class HmmLauncherMDB extends SeriesLauncherMDB {
