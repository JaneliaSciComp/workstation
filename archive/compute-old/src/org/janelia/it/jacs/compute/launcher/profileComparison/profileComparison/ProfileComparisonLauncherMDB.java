...
package org.janelia.it.jacs.compute.launcher.profileComparison.profileComparison;
 ...
 * @author Tareq Nabeel
 */
@MessageDriven(name = "ProfileComparisonLauncherMDB", activationConfig = {
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge "),
        @ActivationConfigProperty(propertyName = "messagingType", propertyValue = "javax.jms.MessageListener"),
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/profileComparisonLauncher"),
...
public class ProfileComparisonLauncherMDB extends SeriesLauncherMDB {
