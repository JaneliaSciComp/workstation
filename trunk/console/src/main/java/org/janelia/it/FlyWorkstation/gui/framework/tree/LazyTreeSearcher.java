 ...
 */
public abstract class LazyTreeSearcher extends SimpleWorker {
     ...
     */
    public LazyTreeSearcher(DynamicTree dynamicTree, String searchString, DefaultMutableTreeNode startingNode, 
