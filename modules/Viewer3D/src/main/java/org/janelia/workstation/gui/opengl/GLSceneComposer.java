...
import org.janelia.workstation.gui.opengl.stereo3d.MonoStereoMode;
import org.janelia.workstation.gui.opengl.stereo3d.StereoMode;
import org.janelia.workstation.signal.Signal;
import org.janelia.workstation.signal.Slot;
import org.janelia.workstation.signal.Slot1;
...
implements GLEventListener
{
	...
	public void init(GLAutoDrawable glDrawable) {
        ...
        // Why does GL_FRAMEBUFFER_SRGB work here, but not in large volume viewer?
	...
	public void setStereoMode(StereoMode mode) {
	    ...
	    if (this.stereoMode != mode) {
	        ...
	        mode.reshape(glComponent.getSurfaceWidth(), glComponent.getSurfaceHeight());
	    }
		viewChangedSignal.emit();
	}
