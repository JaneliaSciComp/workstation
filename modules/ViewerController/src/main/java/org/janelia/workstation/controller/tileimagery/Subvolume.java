...
public class Subvolume {
    ...
    /**
     * You probably want to run this constructor in a worker thread, because it
     * can take a while to load its raster data over the network.
     *
     * @param corner1
     * @param corner2
     * @param wholeImage
    ...
    /**
     * You probably want to run this constructor in a worker thread, because it
     * can take a while to load its raster data over the network. This is called
     * only from the 3D viewer feed path.
     *
     * @param center volume around here, in 3D
     * @param wholeImage
     * @param micrometerVoxels as might be supplied by tile format,
     * 1/min-voxelMicrometers.
    ...
    /**
     * Find the least corner containing the center vec, and within the size of
     * rectangular solid dictated by the dimensions given.
     *
