package org.janelia.workstation.controller.access.rest;
 ...
 */
public class RestTiledMicroscopeDomainMgr implements TiledMicroscopeDomainMgr {
    private final int NUM_PARALLEL_NEURONSTREAMS = 4;
    private static final Logger LOG = LoggerFactory.getLogger(RestTiledMicroscopeDomainMgr.class);
    ...
    public static TiledMicroscopeDomainMgr getDomainMgr() {
        if (instance==null) {
            instance = new RestTiledMicroscopeDomainMgr();
        }
        return instance;
    }
    ...
    private RestTiledMicroscopeDomainMgr() {
