...
public class OmeZarrVolumeChannelActor extends BasicGL3Actor implements DepthSlabClipper {
    ...
    private final OmeZarrTileCache dynamicTiles;
    ...
    public OmeZarrVolumeChannelActor(OmeZarrVolumeActor parent, int colorChannel) {
        super(parent);
        chooser = new OmeZarrBlockChooser();
        blockDisplayUpdater = new BlockDisplayUpdater<>(chooser);
        dynamicTiles = new OmeZarrTileCache(null, colorChannel);
