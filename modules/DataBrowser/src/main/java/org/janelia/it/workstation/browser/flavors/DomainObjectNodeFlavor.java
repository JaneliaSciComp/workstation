package org.janelia.it.workstation.browser.flavors;
...
public class DomainObjectNodeFlavor extends DataFlavor {
    ...
    public static final DataFlavor SINGLE_FLAVOR = createConstant("application/x-domain-object;class=org.janelia.it.workstation.browser.nodes.DomainObjectNode","Domain Object Node");
