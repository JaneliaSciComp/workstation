 ...
 */
public class OpenInNeuronAnnotatorActionListener implements ActionListener {

    private final static Logger log = LoggerFactory.getLogger(OpenInNeuronAnnotatorActionListener.class);
    ...
    public OpenInNeuronAnnotatorActionListener(NeuronFragment fragment) {
        this.fragment = fragment;
    }

    public OpenInNeuronAnnotatorActionListener(NeuronSeparation separation) {
        this.separation = separation;
    }

    public OpenInNeuronAnnotatorActionListener(PipelineResult result) {
        this.result = result;
    }
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        ActivityLogHelper.logUserAction("OpenInNeuronAnnotatorActionListener.doAction", fragment==null?separation:fragment.getSeparationId());
